...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','Link','Image','Table','-','TextColor','BGColor'],
	'/',
	['Bold','Italic','Underline','-','OrderedList','UnorderedList'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','Outdent','Indent','Style'],
	'/',
