...
<table border="0" width="667" id="table1" cellspacing="0" cellpadding="0">
	...
	<%
		...
		If txtCategory = "searchbook" Then
			...
			txtBookName		= Request.Form("txtBookName")
			txtSummary		= Request.Form("txtSummary")
			txtAuthorName	= Request.Form("txtAuthorName")
			strSQL = SearchNoneCategory(txtSearchKey,txtBookName,txtSummary,txtAuthorName)
		Else
			strSQL = LoadSQL()	
		End If
	...
	<tr>
		<td>
		<p align="center"><b>Không tồn tại sách giống với khóa tìm kiếm mà bạn nhập! <br>
		Kích <a href="JavaScript:history.back();">vào đây</a> để quay lại trang tìm kiếm!</b></td>
	</tr>
	<tr>
			...
			<tr>
				...
				<table border="0" width="100%" id="table5" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<b>:</b></td>
						<td width="56%" height="17"><%=rsBookResult("AUTHOR")%></td>
						<td width="1%" height="17"></td>
					</tr>
					<tr>
						<td width="1%">&nbsp;</td>
					...
					<tr>
						<td width="1%">&nbsp;</td>
						<td width="20%">
						<p style="margin-top: 2px; margin-bottom: 2px"><b>Tóm tắt</b></td>
						<td width="2%">
