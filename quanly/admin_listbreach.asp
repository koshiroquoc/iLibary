				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							...
							<font color="#FF0000" size="2"><b>&nbsp;</b></font><p style="margin-top: 2px; margin-bottom: 2px" align="center">
							<font color="#FF0000" size="2"><b>&nbsp;DANH SÁCH ĐỘC GIẢ VI PHẠM</b></font></td>
							</tr>
						<tr>
							<td width="10">&nbsp;</td>
							<td>&nbsp;</td>
									...
									<table border="0" width="100%" id="table7" cellspacing="0" cellpadding="0" height="21">
										<tr>
											...
											<table border="1" width="75" id="table10" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onClick="JavaScript:openWindowPrint('admin_print.asp?typeprint=breach&class=<%=txtClassID%>');"><p align="center">
													<span style="font-size: 8pt">
						...
						<tr>
							...
							<%
								...
								If txtCategoryFilter ="" Then
									strSQL = "SELECT * FROM BREACH Order by BOOK_ID ASC"
								Else
									If txtCategoryFilter ="All" Then
										strSQL = "SELECT * FROM BREACH Order by CARD_ID ASC"
									Else
										strSQL = "SELECT * FROM BREACH WHERE left(CARD_ID,2) ='"& txtCategoryFilter & "'"
							...
							<table border="1" width="100%" bordercolorlight="#FFFFFF" cellspacing="0" cellpadding="0" bordercolordark="#CCCCCC">
								<tr>
									...
									<b>Mã thẻ</b></td>
									<td align="center" width="127" bgcolor="#EEEEEE" height="20">
									<b>Họ và tên</b></td>
									<td align="center" width="54" bgcolor="#EEEEEE" height="20">
									<b>Đơn vị</b></td>
									<td align="center" width="176" bgcolor="#EEEEEE" height="20">
									<b>Tên sách</b></td>
						...
						<form method="POST" name="frmFilter" action="admin_listbreach.asp">
