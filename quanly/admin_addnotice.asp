...
<%
	...
	If txtCategory = "notice" Then				
		...
		strSQL = "INSERT INTO NOTICE(ID,TITLE,SUMMARY,CONTENT,DATE_INFORM) VALUES("
		...
		Response.Redirect("admin_listnotice.asp")
	Else
%>
<html>
					...
					<div align="center">
						<table border="0" width="573" id="table3" cellspacing="0" cellpadding="0">
							<tr>
								...
								<b>&nbsp;</b></font><p style="margin-top: 2px; margin-bottom: 2px" align="center">
								<font color="#FF0000" size="2">
								<b>&nbsp;THÊM THÔNG BÁO</b></font></td>
							</tr>
							<tr>
								<td colspan="4">&nbsp;</td>
							</tr>
							...
							<form method="POST" name="frmNotice" action="admin_addnotice.asp">
							<tr>
								<td width="14">&nbsp;</td>
								<td width="91"><b>Tên thông báo</b></td>
								<td width="459">
							...
							<tr>
								...
								<textarea rows="4" name="txtContent" cols="51" class="input_text"></textarea>
								</td>
