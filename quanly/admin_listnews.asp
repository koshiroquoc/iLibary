				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							...
							<p style="margin-top: 2px; margin-bottom: 2px" align="center"><b>&nbsp;<font size="2" color="#FF0000"> 
							DANH SÁCH TIN TỨC</font></b></td>
							</tr>
						<tr>
							<td width="10">&nbsp;</td>
							<td>&nbsp;</td>
							...
							<table border="1" width="100%" bordercolorlight="#FFFFFF" cellspacing="0" cellpadding="0" bordercolordark="#CCCCCC" height="22" bgcolor="#EEEEEE">
								<tr>
									...
									<table border="0" width="100%" id="table3" cellspacing="0" cellpadding="0" height="21">
										<tr>
											<td width="122"><b>&nbsp; Lọc theo thể loại tin</b></td>
											<td>
											...
											<table border="1" width="65" id="table6" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onclick="JavaScript:doSubmit('admin_delete.asp?category=news');"><p align="center">
											...
											<table border="1" width="60" id="table4" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onClick="window.location.href='admin_addnews.asp'"><p align="center">
													<span style="font-size: 8pt">
													Tạo mới</span></td>
												</tr>
											</table>
						...
						<tr>
							...
							<%							
								...
								Else
									If Request.Form("txtCategoryFilter")= 0 Then
										strSQL = "SELECT * FROM NEWS Order by DATE_INFORM Desc"
									Else
										strSQL = "SELECT * FROM NEWS WHERE CATEGORY_ID="& Request.Form("txtCategoryFilter")
							...
							<table border="1" width="100%" bordercolorlight="#FFFFFF" cellspacing="0" cellpadding="0" bordercolordark="#CCCCCC">
								...
								<%
									...
									strSQL = "SELECT * FROM CATEGORY_NEWS WHERE ID=" & rsSelect("CATEGORY_ID")
								...
								<tr>
									...
									<a href="admin_editnews.asp?id=<%=rsSelect("ID")%>"><%=rsSelect("TITLE")%></a></td>
									<td width="142">
						...
						<form method="POST" name="frmFilter" action="admin_listnews.asp">
