...
<%
	...
	If txtCategory = "newscategory" Then				
		...
		If txtID <> "" Then
			strSQL = "UPDATE CATEGORY_NEWS SET "
			strSQL = strSQL & "NAME="& CheckString(txtName,"")
			strSQL = strSQL & "WHERE ID=" & cInt(txtID)
		Else
			strSQL = "SELECT * FROM CATEGORY_NEWS Order by ID Desc"		
			txtID = GetID(strSQL,Conn)			
			strSQL = "INSERT INTO CATEGORY_NEWS(ID,Name)Values("
		...
		Response.Redirect("admin_newscategory.asp")
	Else
		If id <> "" Then
			Set rsEdit = Server.CreateObject("ADODB.Recordset")
			strSQL = "SELECT * FROM CATEGORY_NEWS WHERE ID=" & cInt(id)
			rsEdit.CursorType = 2
			rsEdit.LockType = 3
				...
				<tr>
					...
					<table border="0" width="100%" id="table3" cellspacing="0" cellpadding="0">
						<tr>
								...
								<b>&nbsp;<font size="2" color="#FF0000"> THỂ LOẠI TIN TỨC</font></b></td>
							</tr>
						<tr>
							<td width="2%">&nbsp;</td>
							<td colspan="4">&nbsp;</td>
						...
						<tr>
							<form method="POST" name="frmNewsCategory" action="admin_newscategory.asp">
								<td width="2%">&nbsp;</td>
								<td width="16%">&nbsp;</td>
								...
								<tr>
									...
									<table border="1" width="100%" id="table5" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF" bordercolordark="#999999" bordercolor="#000080">
										<tr>
											...
											<td width="82" align="center" bgcolor="#EEEEEE" height="20">&nbsp;</td>
										</tr>
										<%
											Dim iCount
											iCount = 1
										...
										<tr>
											...
											<td width="82">
											<p align="center">
											<a href="admin_newscategory.asp?id=<%=rsSelect("ID")%>">
											<font size="2">Sửa</font></a><font size="2">&nbsp; |&nbsp;</font><a href="admin_delete.asp?category=newscategory&id=<%=rsSelect("ID")%>"><font size="2"> Xóa</font></a></td>
										</tr>
										<%
											iCount = iCount + 1
											rsSelect.MoveNext											
