...
<%
	...
	If txtCategory = "language" Then				
		...
		If txtID <> "" Then
			strSQL = "UPDATE LANGUAGE SET "
			strSQL = strSQL & "NAME="& CheckString(txtName,"")
			strSQL = strSQL & "WHERE ID=" & cInt(txtID)
		Else
			strSQL = "SELECT * FROM LANGUAGE Order by ID Desc"		
			txtID = GetID(strSQL,Conn)			
			strSQL = "INSERT INTO LANGUAGE(ID,Name)Values("
		...
		Response.Redirect("admin_language.asp")
	Else
		If id <> "" Then
			Set rsEdit = Server.CreateObject("ADODB.Recordset")
			strSQL = "SELECT * FROM LANGUAGE WHERE ID=" & cInt(id)
			rsEdit.CursorType = 2
			rsEdit.LockType = 3
				...
				<tr>
					...
					<table border="0" width="100%" id="table3" cellspacing="0" cellpadding="0">
						<tr>
							...
							<font color="#FF0000" size="2">NGÔN NGỮ SÁCH</font></b></td>
							</tr>
						<tr>
							<td colspan="6">&nbsp;</td>
						</tr>
						...
						<tr>
							<form method="POST" name="frmLanguage" action="admin_language.asp">
								<td width="2%">&nbsp;</td>
								<td width="23%">&nbsp;</td>
								<td width="14%"><b><font size="2">Tên ngôn ngữ</font></b></td>
								<td width="22%">
								<font size="2">
								<input type="text" name="txtName" size="18" class="input_text" value="<%=txtName%>"></font></td>
								<td width="38%">
								<font size="2">
								...
								<tr>
									...
									<table border="1" width="100%" id="table5" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF" bordercolordark="#999999" bordercolor="#000080">
										<tr>
											...
											<font size="2">Tên ngôn ngữ</font></b></td>
											<td width="87" align="center" bgcolor="#EEEEEE" height="20">&nbsp;</td>
										</tr>
										<%
											Dim iCount
											iCount = 1
										...
										<tr>
											...
											<td width="87">
											<p align="center">
											<a href="admin_language.asp?id=<%=rsSelect("ID")%>">
											<font size="2">Sửa</font></a><font size="2">&nbsp; |&nbsp;</font><a href="admin_delete.asp?category=language&id=<%=rsSelect("ID")%>"><font size="2"> Xóa</font></a></td>
										</tr>
										<%
											iCount = iCount + 1
											rsSelect.MoveNext											
