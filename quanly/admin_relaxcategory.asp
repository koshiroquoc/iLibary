...
<%
	...
	If txtCategory = "relaxcategory" Then				
		...
		If txtID <> "" Then
			strSQL = "UPDATE CATEGORY_RELAX SET "
			strSQL = strSQL & "NAME="& CheckString(txtName,"")
			strSQL = strSQL & "WHERE ID=" & cInt(txtID)
		Else
			strSQL = "SELECT * FROM CATEGORY_RELAX Order by ID Desc"		
			txtID = GetID(strSQL,Conn)			
			strSQL = "INSERT INTO CATEGORY_RELAX(ID,Name)Values("
		...
		Response.Redirect("admin_relaxcategory.asp")
	Else
		If id <> "" Then
			Set rsEdit = Server.CreateObject("ADODB.Recordset")
			strSQL = "SELECT * FROM CATEGORY_RELAX WHERE ID=" & cInt(id)
			rsEdit.CursorType = 2
			rsEdit.LockType = 3
			...
			<table border="0" width="984" id="table2" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					...
					<table border="0" width="100%" id="table3" cellspacing="0" cellpadding="0">
						...
						<tr>
							<form method="POST" name="frmRelaxCategory" action="admin_relaxcategory.asp">
								<td width="2%">&nbsp;</td>
								<td width="18%">&nbsp;</td>
								<td width="14%"><b><font size="2">Tên thể loại</font></b></td>
								<td width="27%">
								<font size="2">
								...
								<td width="2%">&nbsp;</td>
								<input type="hidden" name="category" value="relaxcategory">
								...
								<tr>
									...
									<table border="1" width="100%" id="table5" cellspacing="0" cellpadding="0" bordercolorlight="#FFFFFF" bordercolordark="#999999" bordercolor="#000080">
										...
										<tr>
											...
											<td width="87">
											<p align="center">
											<a href="admin_relaxcategory.asp?id=<%=rsSelect("ID")%>">
											<font size="2">Sửa</font></a><font size="2">&nbsp; |&nbsp;</font><a href="admin_delete.asp?category=relaxcategory&id=<%=rsSelect("ID")%>"><font size="2"> Xóa</font></a></td>
										</tr>
										<%
											iCount = iCount + 1
											rsSelect.MoveNext											
