					...
					<div align="center">
						<table border="0" width="573" id="table3" cellspacing="0" cellpadding="0">
							<tr>
								...
								<b>THÔNG TIN GIẢI TRÍ</b></font></td>
							</tr>
							<tr>
								<td colspan="8">&nbsp;</td>
							</tr>
							...
							<tr>
								...
								<a href="admin_relaxcategory.asp">
								...
								<a href="admin_addrelax.asp">
								<img border="0" src="../images/relax.gif" width="40" height="39"></a></td>
								<td width="18">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="114">
								<p style="margin-top: 0; margin-bottom: 3px" align="center">
								<a href="admin_listrelax.asp">
