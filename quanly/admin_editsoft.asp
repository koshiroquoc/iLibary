					...
					<div align="center">
						<table border="0" width="573" id="table3" cellspacing="0" cellpadding="0">
							<tr>
								...
								<b>&nbsp; <font color="#FF0000" size="2">HIỆU CHỈNH TIỆN ÍCH</font></b></td>
							</tr>
							<tr>
								<td colspan="4">&nbsp;</td>
							</tr>
							...
							<tr>
								<td width="14">&nbsp;</td>
								<td width="91"><b>Tên tiện ích</b></td>
								<td width="459" colspan="2">
								<input type="text" name="txtTitle" size="34" class="input_text" value="<%=rsEdit("NAME")%>"></td>
								<td width="9">
								&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<b>Giới thiệu</b></td>
								<td width="459" colspan="2">
								<textarea rows="5" name="txtSummary" cols="70" class="input_text"><%=rsEdit("SUMMARY")%></textarea></td>
								<td width="9">
								&nbsp;</td>
							</tr>
								<tr>
							...
							<tr>
								...
								<td height="14" width="91" valign="top"><b>File 
								đính kèm</b></td>
								<td height="14" width="173">
								<input type="text" name="txtFilePath" size="27" class="input_text" value="<%=rsEdit("FILE_PATH")%>"></td>
								<td height="14" width="286">
