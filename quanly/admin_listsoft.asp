				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
									...
									<table border="0" width="100%" id="table7" cellspacing="0" cellpadding="0" height="21">
										<tr>
											...
											<table border="1" width="65" id="table8" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onClick="JavaScript:doSubmit('admin_delete.asp?category=soft');"><p align="center">
											...
											<table border="1" width="60" id="table10" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onClick="window.location.href='admin_addsoft.asp'"><p align="center">
													<span style="font-size: 8pt">
													Tạo mới</span></td>
												</tr>
											</table>
						...
						<tr>
							...
							<td>
							<%
								strSQL = "SELECT * FROM SOFTWARE Order by DATE_INFORM Desc"
							...
							<table border="1" width="100%" bordercolorlight="#FFFFFF" cellspacing="0" cellpadding="0" bordercolordark="#CCCCCC">
								<tr>
									...
									<td align="center" width="290" bgcolor="#EEEEEE" height="20">
									<b>Tên tiện ích</b></td>
									<td align="center" width="124" bgcolor="#EEEEEE" height="20">
									<b>Thể loại</b></td>
								...
								<%
									...
									strSQL = "SELECT * FROM CATEGORY_SOFT WHERE ID=" & rsSelect("CATEGORY_ID")
								...
								<tr>
									...
									<a href="admin_editsoft.asp?id=<%=rsSelect("ID")%>"><%=rsSelect("NAME")%></a></td>
									<td width="124">
