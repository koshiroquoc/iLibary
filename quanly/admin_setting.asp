					...
					<div align="center">
						<table border="0" width="573" id="table3" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<a href="admin_interface.asp">
								<font size="2">
								<img border="0" src="../images/web.gif" width="40" height="39"></font></a></td>
								<td width="14">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="115">
								<p align="center" style="margin-top: 0; margin-bottom: 3px">
								<a href="admin_librarysetting.asp">
								<font size="2">
								<img border="0" src="../images/libraryset.gif" width="40" height="39"></font></a></td>
								<td width="18">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="114">
								<p style="margin-top: 0; margin-bottom: 3px" align="center">
								<a href="admin_backup.asp">
								<font size="2">
								<img border="0" src="../images/backup.gif" width="40" height="39"></font></a></td>
								<td width="10">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="63">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
							...
							<tr>
								...
								<font size="2">Cấu 
								hình giao diện</font></b></td>
								<td width="14">
								<p style="margin-top: 3px">&nbsp;</td>
								<td width="115">
								<p align="center" style="margin-top: 3px"><b>
								<font size="2">Thiết lập thư viện</font></b></td>
								<td width="18">
								<p style="margin-top: 3px">&nbsp;</td>
								<td width="114">
								<p align="center" style="margin-top: 3px"><b>
