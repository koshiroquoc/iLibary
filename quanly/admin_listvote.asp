				...
				<tr>
					...
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
									...
									<table border="0" width="100%" id="table7" cellspacing="0" cellpadding="0" height="21">
										<tr>
											...
											<table border="1" width="65" id="table8" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onclick="JavaScript:doSubmit('admin_delete.asp?category=vote');"><p align="center">
											...
											<table border="1" width="60" id="table10" cellspacing="0" cellpadding="0" bgcolor="#EEEEEE" bordercolorlight="#CCCCCC" bordercolordark="#FFFFFF" height="19">
												<tr>
													<td valign="top" style="cursor:hand" onMouseOver="this.style.background='#FFFFFF'" onMouseOut="this.style.background='#EEEEEE'" onClick="window.location.href='admin_addvote.asp'"><p align="center">
													<span style="font-size: 8pt">
													Tạo mới</span></td>
												</tr>
											</table>
						...
						<tr>
							...
							<td>
							<%
								strSQL = "SELECT * FROM QUESTION Order by DATE_INFORM Desc"
							...
							<table border="1" width="100%" bordercolorlight="#FFFFFF" cellspacing="0" cellpadding="0" bordercolordark="#CCCCCC">
								<tr>
									...
									<td align="center" width="336" bgcolor="#EEEEEE" height="20"><b>Tên 
									câu hỏi</b></td>
									<td align="center" width="79" bgcolor="#EEEEEE" height="20">
									<b>Trạng thái</b></td>
								...
								<tr>
									...
									<td width="336">
									<p align="justify" style="margin-left: 4px; margin-right: 4px"><%=rsSelect("NAME")%></td>
									<td width="79">
									<p align="center"><%=strStatus%></td>
