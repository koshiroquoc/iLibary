					...
					<div align="center">
						<table border="0" width="573" id="table3" cellspacing="0" cellpadding="0">
							<tr>
								...
								<b><font size="2" color="#FF0000">&nbsp;QUẢN LÝ TIN TỨC</font></b></td>
							</tr>
							<tr>
								<td colspan="8">&nbsp;</td>
							</tr>
							...
							<tr>
								...
								<a href="admin_addnews.asp">
								<img border="0" src="../images/news.gif" width="40" height="39"></a></td>
								<td width="18">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="114">
								<p style="margin-top: 0; margin-bottom: 3px" align="center">
								<a href="admin_listnews.asp">
