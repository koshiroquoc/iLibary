				...
				<tr>
					...
					<div align="center">
						<table border="0" width="573" id="table3" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="8" background="../images/bg_title.gif" height="19">
								<p style="margin-top: 2px; margin-bottom: 2px" align="center">
								<b>&nbsp;QUẢN LÝ TIN TỨC</b></td>
							</tr>
							<tr>
								<td colspan="8">&nbsp;</td>
							</tr>
							...
							<tr>
								...
								<a href="admin_addvote.asp">
								<img border="0" src="../images/vote_new.gif" width="40" height="39"></a></td>
								<td width="14">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="115">
								<p align="center" style="margin-top: 0; margin-bottom: 3px">
								<a href="admin_listvote.asp">
								<img border="0" src="../images/list.gif" width="40" height="39"></a></td>
								<td width="18">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="114">
								<p style="margin-top: 0; margin-bottom: 3px" align="center">
								<img border="0" src="../images/vote_new.gif" width="40" height="39"></td>
								<td width="10">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
								<td width="63">
								<p style="margin-top: 0; margin-bottom: 3px">&nbsp;</td>
							...
							<tr>
								...
								<p style="margin-top: 3px">&nbsp;</td>
								<td width="114">
								<p align="center" style="margin-top: 3px"><b>Xem 
								kết quả</b></td>
								<td width="10">
								<p style="margin-top: 3px">&nbsp;</td>
								<td width="63">
