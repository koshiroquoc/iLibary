		...
		<div align="center">
			<table border="0" width="984" id="table2" cellspacing="0" cellpadding="0" align="center">
				...
				<tr>
					...
					<div align="center">
						<table border="0" width="667" id="table3" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="3" height="19">
								<p style="margin-top: 2px; margin-bottom: 2px" align="center">
								&nbsp;<p style="margin-top: 2px; margin-bottom: 2px" align="center">
								<font color="#FF0000" size="2">
								<b>QUẢN TRỊ WEBSITE</b></font></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
							...
							<tr>
								<td width="145" height="274">&nbsp;</td>
								<td width="300" height="274" background="../images/elibrary.gif">
								<p align="center">&nbsp;</td>
								<td width="128" height="274">&nbsp;</td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>
